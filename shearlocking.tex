...
\begin{figure}[H]
    \centering
        \begin{tabular}{c@{\hspace{24pt}}c}
            \includegraphics[width=0.25\textwidth]{figures/ch_5/SquarePlate_8_msh.png} &
            \includegraphics[width=0.25\textwidth]{figures/ch_5/SquarePlate_16_msh.png} \\
            $8\times 8$ & $16\times 16$ \\
            \includegraphics[width=0.25\textwidth]{figures/ch_5/SquarePlate_32_msh.png} &
            \includegraphics[width=0.25\textwidth]{figures/ch_5/SquarePlate_64_msh.png} \\
