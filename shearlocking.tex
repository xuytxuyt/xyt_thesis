...
图\ref{ch_5:fig:plate_quad_q}为四边形单元的压力云图。结果表明，对于四边形单元，$r=3:2$时的应力云图存在应力振荡现象，而本文提出的离散方案缓解了应力振荡现象。上述结果充分验证了本文所提最优约束比范围的正确性，同时证明了混合离散方案在缓解应力振荡现象方面的有效性。图\ref{ch_5:fig:plate_quad_q}为固支方板问题Quad4和Quad8单元的应力云图。从图中可以观察到，对于四边形单元$r=2$时存在应力振荡现象，而本文提出的混合离散方案则有效的缓解了这一现象。图\ref{ch_5:fig:SquarePlate_quad}为四边形单元位移和压力误差对比图。
...
\begin{figure}[!h]
    ...
    \begin{subcaptiongroup}
        \begin{tabular}{c@{\hspace{0pt}}c}
            \raisebox{-0.7\height}{\includegraphics[width=0.45\textwidth]{figures/ch_5/MorleysAcuteSkewPlate_tri3_q1_64_64.png}}
            & \raisebox{-0.7\height}{\includegraphics[width=0.45\textwidth]{figures/ch_5/MorleysAcuteSkewPlate_tri3_q11_64_64.png}}\\
            mix-Tri3($r=3:2$)&mix-Tri3($r=r_{opt}$)\\
            \raisebox{-0.7\height}{\includegraphics[width=0.45\textwidth]{figures/ch_5/MorleysAcuteSkewPlate_tri6_q1_32_32.png}}
           & \raisebox{-0.7\height}{\includegraphics[width=0.45\textwidth]{figures/ch_5/MorleysAcuteSkewPlate_tri6_q11_32_32.png}} \\
           mix-Tri6($r=3:2$)&mix-Tri6($r=r_{opt}$) \\
        \end{tabular}
    \end{subcaptiongroup}
...
\begin{figure}[!h]
    ...
    \begin{subcaptiongroup}
        \begin{tabular}{c@{\hspace{0pt}}c}
            \raisebox{-0.7\height}{\includegraphics[width=0.45\textwidth]{figures/ch_5/MorleysAcuteSkewPlate_quad4_q1_64_64.png}}
            & \raisebox{-0.7\height}{\includegraphics[width=0.45\textwidth]{figures/ch_5/MorleysAcuteSkewPlate_quad4_q11_64_64.png}}\\
            mix-Quad4($r=3:2$)&mix-Quad4($r=r_{opt}$)\\
            \raisebox{-0.7\height}{\includegraphics[width=0.45\textwidth]{figures/ch_5/MorleysAcuteSkewPlate_quad8_q1_32_32.png}}
           & \raisebox{-0.7\height}{\includegraphics[width=0.45\textwidth]{figures/ch_5/MorleysAcuteSkewPlate_quad8_q11_32_32.png}} \\
           mix-Quad8($r=3:2$)&mix-Quad8($r=r_{opt}$) \\
        \end{tabular}
    \end{subcaptiongroup}
