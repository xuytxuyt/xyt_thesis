...
\begin{equation}\label{ch_3:eq:b}
    b(q_h,\boldsymbol v_h) = \left (q_h, \frac{1}{3\kappa}\mathcal P \boldsymbol v_h \right ) = (q_h, \frac{1}{3\kappa}\mathcal P_h \boldsymbol v_h), \quad \forall q_h \in Q_h
\end{equation}
...
\begin{equation} \label{ch_3:eq:r12}
        \beta \le \inf_{q_h \in \mathrm{Im}\mathcal P_h} \sup_{\boldsymbol v_h \in V_h} \frac{\vert (q_h,\mathcal P_h \boldsymbol v_h) \vert}{\Vert q_h \Vert_Q \Vert \boldsymbol v_h \Vert_V}
\end{equation}
...
\begin{equation}\label{ch_3:eq:r13}
    ...
    \inf_{q_h \in \mathrm{Im}\mathcal P_h}\sup_{\boldsymbol v_h\in V'_h} \frac{\Vert q_h \Vert_Q \Vert \mathcal P_h \boldsymbol v_h \Vert_Q}{\Vert q_h \Vert_Q \Vert \boldsymbol v_h \Vert_V} \\
    &=\inf_{q_h \in \mathrm{Im}\mathcal P_h}\sup_{\boldsymbol v_h\in V'_h} \frac{\Vert \mathcal P_h \boldsymbol v_h \Vert_Q}{\Vert \boldsymbol v_h \Vert_V} \\
    &=\inf_{V'_h \subset V_h\ker \mathcal P_h} \sup_{\boldsymbol v_h\in V'_h} \frac{\Vert \mathcal P_h \boldsymbol v_h \Vert_Q}{\Vert \boldsymbol v_h \Vert_V} 
    \end{split}
\end{equation}
