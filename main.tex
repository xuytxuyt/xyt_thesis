...
网页链接：\href{https://blog.csdn.net/lyxichigoichie/article/details/125961850}{设置Tmp文件}(存储不必要的文件，但没办法自动更改bbl文件)

设置.gitignore

网页链接：\href{https://blog.csdn.net/hjc_042043/article/details/135965334}{设置.gitignore}(提交时忽略不必要文件(*.aux,*.toc,\dots))
\section{VS code配置}
\subsection*{配置Latex}
在VSCode中修改LaTex WorkShop配置,网页链接\href{https://zhuanlan.zhihu.com/p/166523064}{vsocde中的Latex配置}
